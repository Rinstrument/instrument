...
#include "stanExports_inirt_hoirt.h"

RCPP_MODULE(stan_fit4inirt_hoirt_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_inirt_hoirt")
