...
#include "stanExports_inirt_bifac.h"

RCPP_MODULE(stan_fit4inirt_bifac_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_inirt_bifac")
