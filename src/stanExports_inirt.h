...
namespace model_inirt_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_inirt");
    reader.add_event(29, 27, "end", "model_inirt");
    return reader;
}
#include <stan_meta_header.hpp>
class model_inirt
  : public stan::model::model_base_crtp<model_inirt> {
private:
        int N;
        int J;
        int N_long;
        ...
        std::vector<int> y;
public:
    model_inirt(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_inirt_namespace::model_inirt";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "N_long", "int", context__.to_vec());
            N_long = int(0);
            vals_i__ = context__.vals_i("N_long");
            pos__ = 0;
            N_long = vals_i__[pos__++];
            check_greater_or_equal(function__, "N_long", N_long, 1);
            current_statement_begin__ = 5;
            validate_non_negative_index("nn", "N_long", N_long);
            context__.validate_dims("data initialization", "nn", "int", context__.to_vec(N_long));
            nn = std::vector<int>(N_long, int(0));
            vals_i__ = context__.vals_i("nn");
            pos__ = 0;
            size_t nn_k_0_max__ = N_long;
            for (size_t k_0__ = 0; k_0__ < nn_k_0_max__; ++k_0__) {
                nn[k_0__] = vals_i__[pos__++];
            }
            size_t nn_i_0_max__ = N_long;
            for (size_t i_0__ = 0; i_0__ < nn_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "nn[i_0__]", nn[i_0__], 1);
                check_less_or_equal(function__, "nn[i_0__]", nn[i_0__], N);
            }
            current_statement_begin__ = 6;
            validate_non_negative_index("jj", "N_long", N_long);
            context__.validate_dims("data initialization", "jj", "int", context__.to_vec(N_long));
            jj = std::vector<int>(N_long, int(0));
            vals_i__ = context__.vals_i("jj");
            pos__ = 0;
            size_t jj_k_0_max__ = N_long;
            for (size_t k_0__ = 0; k_0__ < jj_k_0_max__; ++k_0__) {
                jj[k_0__] = vals_i__[pos__++];
            }
            size_t jj_i_0_max__ = N_long;
            ...
            context__.validate_dims("data initialization", "y", "int", context__.to_vec(N_long));
            y = std::vector<int>(N_long, int(0));
            vals_i__ = context__.vals_i("y");
            pos__ = 0;
            size_t y_k_0_max__ = N_long;
            for (size_t k_0__ = 0; k_0__ < y_k_0_max__; ++k_0__) {
                y[k_0__] = vals_i__[pos__++];
            }
            size_t y_i_0_max__ = N_long;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("delta", "J", J);
        context__.validate_dims("parameter initialization", "delta", "vector_d", context__.to_vec(J));
        Eigen::Matrix<double, Eigen::Dynamic, 1> delta(J);
        size_t delta_j_1_max__ = J;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                delta = in__.vector_constrain(J, lp__);
            else
                delta = in__.vector_constrain(J);
            current_statement_begin__ = 12;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> alpha;
            (void) alpha;  // dummy to suppress unused var warning
            if (jacobian__)
                alpha = in__.vector_lb_constrain(0, J, lp__);
            else
                alpha = in__.vector_lb_constrain(0, J);
            // model body
            ...
            lp_accum__.add(lognormal_log<propto__>(alpha, 0, 1));
            current_statement_begin__ = 26;
            lp_accum__.add(bernoulli_logit_log<propto__>(y, subtract(elt_multiply(stan::model::rvalue(alpha, stan::model::cons_list(stan::model::index_multi(jj), stan::model::nil_index_list()), "alpha"), stan::model::rvalue(theta, stan::model::cons_list(stan::model::index_multi(nn), stan::model::nil_index_list()), "theta")), stan::model::rvalue(delta, stan::model::cons_list(stan::model::index_multi(jj), stan::model::nil_index_list()), "delta"))));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_inirt_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> delta = in__.vector_constrain(J);
        size_t delta_j_1_max__ = J;
        for (size_t j_1__ = 0; j_1__ < delta_j_1_max__; ++j_1__) {
            vars__.push_back(delta(j_1__));
        }
        Eigen::Matrix<double, Eigen::Dynamic, 1> alpha = in__.vector_lb_constrain(0, J);
        size_t alpha_j_1_max__ = J;
        for (size_t j_1__ = 0; j_1__ < alpha_j_1_max__; ++j_1__) {
...
typedef model_inirt_namespace::model_inirt stan_model;
#ifndef USING_R
